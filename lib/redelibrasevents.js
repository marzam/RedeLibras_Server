function sendEmail(){
    JSReceiver.onClick_sendEmail(document.getElementById("txtemail").value);
}
function callPhone( opt){
  JSReceiver.onClick_callPhone(document.getElementById("txtPhone").value, opt);
}
function callMaps(){
  var addr = document.getElementById("id_txtAddr").value + ";";
  addr +=  document.getElementById("id_txtAddrAdd").value + ";";
  addr +=  document.getElementById("id_txtNeighborhood").value + ";";
  addr +=  document.getElementById("id_txtState").value + ";";
  addr +=  document.getElementById("id_txtCity").value + ";";
  JSReceiver.onClick_callMaps(addr);
}
